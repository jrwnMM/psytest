...
class AddPQuestionsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'category': forms.Select(attrs={'class': 'form-select', 'required': True}, choices=category_choices),
            'key': forms.Select(attrs={'class': 'form-select', 'required': True}, choices=key_choices),
        }